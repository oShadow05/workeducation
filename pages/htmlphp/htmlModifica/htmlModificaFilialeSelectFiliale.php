...
echo " <form class='md-form' id='cred-input-form-upd-filiale'> ";
...
echo "<select id='get-select-filiale' class='browser-default custom-select disable-2 disable-dip-2 bg-primary  custom-select-lg mb-3 text-white'>";
...
echo "</select>";
echo "<div class='btn submit btn-outline-info btn-rounded btn-block waves-effect z-depth-0 update-dip-2' id='continueSubmitUpdateFiliale-2'><span id='show-loading-update-filiale'><i class='fa fa-edit'></i> Continua</span></div >";
