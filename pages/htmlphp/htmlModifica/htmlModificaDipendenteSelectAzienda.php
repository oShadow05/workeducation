...
echo "<h5 class='title'>Seleziona azienda: </h5>";
  ...
  echo "<select id='get-id-update-az-filiale-dip'  class='browser-default custom-select disable-dip bg-primary  custom-select-lg mb-3 text-white'>";
  ...
  echo "</select>";
  echo "<div class='btn submit btn-outline-info btn-rounded btn-block waves-effect z-depth-0' id='cntSubmitUpdateDipendente'><span id='show-loading-update-filiale'><i class='fa fa-edit'></i> Continua</span></div >";
echo "</form>";
