            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" id="page-name">Stage</li>
                    </ol>
                    ...
                    <div class="card mb-3" id="stage">
                            ...
                            <table  class="table table-bordered" id="dataTableStage" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                  ...
                                  // Query studente Stage
                                    ...
                                    $select = $query->selectForUserPage($_SESSION["username"]);
                        ...
                        <div class="card-footer small text-muted" id="last-update">Updated yesterday at 11:59 PM</div>
                    </div>
